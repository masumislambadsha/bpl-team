...
const Footer = () => {
  return (
    <div className='mt-[-2px] bg-[#060919] flex flex-col items-center justify-center'>
      <img src={FooterImg} alt="" />
      <div className='flex gap-[200px] items-center my-[100px]  '>
        ...
        <div  className='space-y-5'>
            ...
            <div className='flex'>
            <input type="email" placeholder='Enter your email' className='placeholder:p-[20px] font-semibold text-[16px] h-[48px] bg-white  rounded-bl-2xl  rounded-l-2xl' name="" id="" />
            <button className=' cursor-pointer ml-[-2px]'><img src={subscribe} alt="" /></button>
            </div>
        </div>
      </div>
