  ...
  return (
    <div
      ...
      className=" bg-[#131313] bg-no-repeat bg-cover md:px-[165px] py-[59px] rounded-3xl mt-13 flex flex-col justify-center items-center space-y-[18px] mb-[100px]">
        ...
        <div className="border-2 border-[#E7FE29] hover:border-2 hover:border-[#E7FE29] rounded-xl">
        <button className="bg-[#E7FE29] btn  font-bold text-[16px] text-[#131313] px-[20px] py-[19px]  rounded-xl border-6 border-black transition duration-500 hover:scale-120 hover:px-[40px] ">Claim Free Credit</button>
        </div>
    </div>
  );
};
